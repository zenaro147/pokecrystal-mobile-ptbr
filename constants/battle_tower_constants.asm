...
DEF BATTLE_TOWER_DATA_UPLOAD_LENGTH EQU 2 + MOBILE_EMAIL_LENGTH + 4 + PLAYER_NAME_LENGTH - 1 + BATTLETOWER_PARTY_LENGTH * NICKNAMED_MON_STRUCT_LENGTH + EASY_CHAT_MESSAGE_LENGTH * 3 + 6
