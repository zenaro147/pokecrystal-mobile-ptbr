...
.Data:
; introduction
	db $0d, EZCHAT_GREETINGS,    $01, EZCHAT_EXCLAMATIONS
	db $23, EZCHAT_GREETINGS,    $02, EZCHAT_EXCLAMATIONS
; begin battle
	db $29, EZCHAT_CONVERSATION, $04, EZCHAT_EXCLAMATIONS
	db $0d, EZCHAT_FAREWELLS,    $01, EZCHAT_BATTLE
; win battle
	db $3d, EZCHAT_EXCLAMATIONS, $01, EZCHAT_EXCLAMATIONS
	db $04, EZCHAT_BATTLE,       $02, EZCHAT_EXCLAMATIONS
; lose battle
	db $0f, EZCHAT_EXCLAMATIONS, $05, EZCHAT_EXCLAMATIONS
	db $38, EZCHAT_CONVERSATION, $02, EZCHAT_FAREWELLS
